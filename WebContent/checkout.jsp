...
<body> 
	...
	<div class="ckeckout">
			...
			<div class="in-check" >
				...
				<ul class="cart-header">
					<a href="deletebyid.do?id=${carts.id }"><div class="close1"> </div></a>
						...
						<li><span><a href="reducecartnum.do?id=${carts.id }&uid=<%=uid%>"><h1>-</h1></a>${carts.num }<h2><a href="addcartnum.do?id=${carts.id }&uid=<%=uid%>">+</a></h2></span>
						</li>
		...
		</div><a align="center" href="sumcart.do"><h2>提交订单
		</h2></a>
	</div>
