						...
						<div class="box1">
							<%
								...
								Integer uid=(Integer)session.getAttribute("uid");
								 ...
								 Double sum=Double.valueOf(sums.toString());
										%>
						</div>
			...
			<div class="contact-top heading">
				...
				<div class="col-md-3 contact-left">
					...
					<div class="col-md-9 contact-right">
						<form action="insertOrderDetail.do" method="post">
						
							<input type="text" placeholder="Name" name="name">
							<input type="text" placeholder="Phone" name="phone">
							<input type="text"  placeholder="Post" name="post">
							<input type="text"  placeholder="Address" name="address" style="width:700px">
							<textarea placeholder="Message" required=""></textarea>
							<input type="hidden" value=<%=uid %> name="uid">
							<input type="hidden" value=<%=username %> name="username">
							 <input type="hidden" value=<%=sum%> name="sum">
							 <input type="hidden" value="未确认" name="status">
